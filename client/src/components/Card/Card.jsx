...
const Card = () => {
  ...
  const cards = Array(8).fill({
    ...
    taskProgress: "1/2",
    date: "8-11-2024",
    icons: { messages: 12, comments: 15, tasks: 25 },
  });
  ...
  return (
    <div className="w-80 h-screen overflow-x-auto p-4 bg-white shadow-lg">
      ...
      <div className="overflow-y-scroll h-[80vh] scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
        {cards.map((card, index) => (
          <div
            key={index}
            className="bg-gray-100 rounded-lg p-3 mb-3 shadow-md"
          >
            <div className="flex justify-between items-center mb-2">
            ...
            <div className="flex justify-between items-center">
              <div>
                <p className="text-xs text-gray-500">{card.taskDescription}</p>
              </div>
              <div>
            ...
            <div className="flex gap-2 items-center mt-2">
              ...
              <div className="flex items-center space-x-1">
                ...
                <span className="text-xs">{card.icons.tasks}</span>
              </div>
              <div className="flex items-center space-x-1">
